...
async function ensureDemoUser() {
  ...
  const smtpPassword = process.env.EMAIL_PASS ? encrypt(process.env.EMAIL_PASS) : "";
  ...
  if (user) {
    ...
    if (smtpPassword && user.smtpPassword !== smtpPassword) {
...
async function seedDemoEmails(userId: string) {
  ...
  const demoEmails = [
    {
      ...
      content:
        "Hi Sarah, we have put together the roadmap covering all upcoming releases. View it here: https://acmecorp.com/roadmap",
      ...
      clicks: [
        {
          at: daysAgo(0, 9, 33),
          url: "https://acmecorp.com/roadmap",
          device: "Desktop",
          browser: "Chrome",
          os: "Windows",
          ip: "192.168.1.10",
    ...
    },
    {
      ...
      content:
        "Welcome aboard! Get started at https://mailtrack.io/start and book a demo at https://mailtrack.io/demo",
    ...
    },
    {
      ...
      content:
        "Great chatting earlier — here are the resources I mentioned: https://globex.com/resources",
    ...
    },
    {
      ...
      clicks: [
        {
          at: daysAgo(4, 18, 1),
          url: "https://orbit.team/scheduling",
          device: "Desktop",
          browser: "Chrome",
          os: "Windows",
          ip: "192.0.2.1",
    ...
    },
    {
      ...
      content:
        "It has been a while! Here is what is new since you last logged in: https://studioloop.com/whats-new",
    ...
    },
    {
      ...
      clicks: [
        {
          at: daysAgo(6, 8, 1),
          url: "https://cloudbridge.io/digest",
          device: "Desktop",
          browser: "Chrome",
          os: "Windows",
          ip: "10.3.3.1",
    ...
    },
    {
      ...
      clicks: [
        {
          at: daysAgo(6, 11, 1),
          url: "https://hilltop.org/demo-recording",
          device: "Desktop",
          browser: "Firefox",
          os: "Linux",
          ip: "10.4.4.1",
  ...
  console.log(
    `Seeded ${demoEmails.length} demo emails with ${totalOpens} opens and ${totalClicks} clicks`,
  );
}
